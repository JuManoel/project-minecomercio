...
public abstract class Transaccion implements Format {
  ...
  public boolean equals(Object obj) {
    ...
    if (!this.id.equals(other.getId())) {
      // mostrar una advertencia cuando los IDs sean distintos y las descripciones sean iguales
      if (this.fechaHora.equals(other.getFechaHora())) {
        String message = String.format("Advertencia. Los productos con id %s y %s tinen la misma Fecha y Hora \"%s\"", id, other.id, this.fechaHora);
